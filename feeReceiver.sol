...
contract TaxReceiver {
    ...
    // router
    IUniswapV2Router02 public router = IRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function setMinSell(uint256 newMin) external onlyOwner {
        minSell = newMin;
    }
    ...
    {
        canExec = IERC20(token).balanceOf(address(this)) >= minSell;
    }
    ...
    function trigger() external {
        ...
        if (balance > 0) {
            ...
            router.swapExactTokensForETHSupportingFeeOnTransferTokens(balance, 1, swapPath, address(this), block.timestamp + 300);
